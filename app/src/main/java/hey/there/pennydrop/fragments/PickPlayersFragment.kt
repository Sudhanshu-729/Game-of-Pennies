package hey.there.pennydrop.fragments
...
import hey.there.pennydrop.R
import hey.there.pennydrop.databinding.FragmentPickPlayersBinding
import hey.there.pennydrop.viewModel.GameViewModel
import hey.there.pennydrop.viewModel.PickPlayerViewModel
...
class PickPlayersFragment : Fragment() {
    ...
    private val pickPlayersViewModel by activityViewModels<PickPlayerViewModel>()
                ...
                this.playButton.setOnClickListener {
                    gameViewModel.startGame(
                        pickPlayersViewModel.players.value?.filter {
                            newPlayer ->  newPlayer.isIncluded.get()
                        }?.map {
                            newPlayer ->  newPlayer.toPlayer()
                        }?: emptyList()
                    )

                    findNavController().navigate(R.id.gameFragments)
                }
            }
